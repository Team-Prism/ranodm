...
const CACHE_NAME = "ranodm-cache";
const OFFLINE_URL = "ranodm.offline.html";
// Files that will be cached on load.
const CACHED_FILES = ["ranodm.html","ranodm.js","ranodm.wasm","ranodm.pck","ranodm.offline.html","ranodm.icon.png","ranodm.apple-touch-icon.png"];
